...
function JudgeCard({imgUrl, classImage, name, title, bgUrl}: JudgeCardProps) {
    return (
        <div className="relative min-w-[253px] w-[70%] md:w-[25%] aspect-355/472 pointer-events-none select-none">
            <Image
                src={bgUrl || "/images/FAQ/judge-card.svg"}
                alt="Background"
                fill
