...
function JudgeSection() {
    ...
    return (
        <>
            <h2 className="text-[#05B0C1] font-family-audiowide text-center text-[200%] md:text-[330%] glow-pulse px-[3%]">Introduce Our Judges</h2>
            <div className="w-full mt-[2%] aspect-1440/547 bg-[url('/images/faq/bgJudge.svg')] bg-cover bg-center bg-no-repeat relative">
                
                {/* Images of judges */}
                <div className="w-full h-auto pb-[8%] flex flex-col md:flex-row flex-wrap gap-4 justify-evenly items-center overflow-hidden">
