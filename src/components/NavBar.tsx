...
function NavBar() {
  ...
  return (
    <nav className="w-screen overflow-x-hidden fixed z-100 px-[5%] bg-[#1C0951] border-b-2 border-[#00C074] overflow-hidden h-[7vh] flex justify-between gap-4 items-center">
      <Link href={"/"}>
        <Image
